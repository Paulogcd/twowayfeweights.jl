@testset "twowayfeweights_summarize_weights.jl" begin
    ...
    julia_code_result = TwoWayFEWeights.twowayfeweights_summarize_weights(
        df = random_data_frame_test,
        var_weight = "random_weights")

    R_code_result = rcopy(R"TwoWayFEWeights:::twowayfeweights_summarize_weights(
        df = random_data_frame_test,
        var_weight = 'random_weights')")
