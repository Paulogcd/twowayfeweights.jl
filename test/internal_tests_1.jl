Test.@testset "Internal_test_1" begin
    ...
    # Sanity check: 
    Test.@testset "Sanity check" begin
    ...
    # Julia
    data_transformed = twowayfeweights_transform(df = data_renamed, controls = controls_rename, weights = weights, treatments = treatments_rename)
    ...
    # Test
    isequal(data_transformed, RCall.rcopy(R"data_transformed")) # PROBLEM HERE
